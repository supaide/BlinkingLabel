...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/supaide/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'cyij' => 'cyij2006@gmail.com' }
  s.source           = { :git => 'https://github.com/supaide/BlinkingLabel.git', :tag => s.version.to_s }
